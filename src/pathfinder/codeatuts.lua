-- http://codeatuts.blogspot.com/2012/09/15.html
--# FindPath
...
function CalcMoves(board, startX, startY, targetX, targetY)
   ...
   while listk > 0 do
      ...
      if curSquare.x + 1 <= xsize and
          board[curSquare.x+1][curSquare.y] == pathfinder.stateObstacle then
              rightOK = false
      end
      ...
      if curSquare.y + 1 <= ysize and
          board[curSquare.x][curSquare.y+1] == pathfinder.stateObstacle then
              downOK = false
      end
